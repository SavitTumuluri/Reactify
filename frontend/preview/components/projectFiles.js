 ...
 *  - styles?: object with backgroundColor, borderWidth, borderStyle, borderColor, borderRadius, boxShadow, overflow
...
export default function DragResizeStatic({
  ...
  const contentBoxStyle = {
    width: "100%",
    height: "100%",
    borderRadius: readStyle("borderRadius", borderRadius),
...
export default function GraphicBox({
  ...
  const canvasStyle = {
    ...
    width: bounds.w,
    height: bounds.h,
    background: canvasBackground, // Use the prop instead of hardcoded white
    borderRadius: 16,
